...
enum {	// Selectors for EMUL_OP opcodes
	...
	OP_PLUG_TRACE,
	OP_SCSI_BRIDGE_OPEN, OP_SCSI_BRIDGE_PRIME, OP_SCSI_BRIDGE_CONTROL, OP_SCSI_BRIDGE_STATUS,
	OP_MAX
};
...
const uint16 M68K_EMUL_OP_SCSI_BRIDGE_OPEN = M68K_EMUL_BREAK + OP_SCSI_BRIDGE_OPEN;
const uint16 M68K_EMUL_OP_SCSI_BRIDGE_PRIME = M68K_EMUL_BREAK + OP_SCSI_BRIDGE_PRIME;
const uint16 M68K_EMUL_OP_SCSI_BRIDGE_CONTROL = M68K_EMUL_BREAK + OP_SCSI_BRIDGE_CONTROL;
const uint16 M68K_EMUL_OP_SCSI_BRIDGE_STATUS = M68K_EMUL_BREAK + OP_SCSI_BRIDGE_STATUS;
